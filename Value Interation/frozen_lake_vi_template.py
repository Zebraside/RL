...
from value_iteration_template import rl_value_iteration
from value_iteration_template  import get_optimal_action
...
if __name__ == '__main__':
    ...
    for step in range(1000):
        s, current_reward, is_done, _ = mdp.step(get_optimal_action(mdp, state_values, s, gamma))
